...
DST_FOLDER='/home/Speaker/Voice_All_Onefolder_active_numpy25ms10ms_hamming'
...
for root, dirs, files in os.walk(os.path.join(SRC_FOLDER)):
        for file in files:
            ...
            Cube = Audio2numpy_MFSC_hamming(signal, sampling_frequency=fs, frame_length=0.025, frame_stride=0.01, num_filters=40,

...
def mfe(signal, sampling_frequency, frame_length=0.025, frame_stride=0.01,
    ...
    # Stack frames
    frames = stack_frames(signal, sampling_frequency=sampling_frequency, frame_length=frame_length,
...
def mfe_hamming(signal, sampling_frequency, frame_length=0.025, frame_stride=0.01,
          num_filters=40, fft_length=512, low_frequency=0, high_frequency=None):
    """Compute Mel-filterbank energy features from an audio signal.
...
def spectrogram(signal, sampling_frequency, frame_length=0.025, frame_stride=0.01, fft_length=512):
    """Compute Mel-filterbank energy features from an audio signal.
    ...
    return power_spectrum, frame_energies

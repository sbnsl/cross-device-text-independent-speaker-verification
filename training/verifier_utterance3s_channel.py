...
def main():
    ...
    if isTraining:
        lblfileaddress = "/media/sina/DATA/Speech/verification_Utternace_Phone2Phone/verification_sample_train"



        datadir = input_dir_train
    else:
        lblfileaddress = "/media/sina/DATA/Speech/verification_Utternace_Phone2Phone/verification_sample_test"
